...
namespace SalaryCounter.ServiceTest.Data
{
    internal static class EmployeeTestData
    {
        ...
        public static Dictionary<string, Employee> EmployeesDictionary { get; } =
            ...
            {
                {
                    "first", new Employee("first", new DateTime(2018, 11, 1), 2000m,
                        EmployeeTypeTestData.Manager, First)
                },
                {
                    "second", new Employee("second", new DateTime(2020, 5, 5), 1500m,
                        EmployeeTypeTestData.Sales,
                        Second, First)
                },
                {
                    "third", new Employee("third", new DateTime(2019, 7, 1), 1000m,
                        EmployeeTypeTestData.Workman, Third, Second)
                },
                {
                    "fourth", new Employee("fourth", new DateTime(1900, 11, 11), 2000m,
                        EmployeeTypeTestData.Manager, Guid.NewGuid(), First)
                },
                {
                    "fifth", new Employee("fifth", new DateTime(2023, 11, 11), 1000m,
