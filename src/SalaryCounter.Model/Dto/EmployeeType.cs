...
namespace SalaryCounter.Model.Dto
{
    ...
    public sealed class EmployeeType
    {
        ...
        ///     Position name
        /// </summary>
        [JsonProperty] public EmployeeTypeName Value { get; set; }
        /// <summary>
        ///     Determines whether employee with this position can have subordinates or not
        /// </summary>
        [JsonProperty] public bool CanHaveSubordinates { get; set; }
        /// <summary>
        ///     Bonuses specification
        /// </summary>
        [JsonProperty] public SalaryRatio SalaryRatio { get; set; }
    }
}