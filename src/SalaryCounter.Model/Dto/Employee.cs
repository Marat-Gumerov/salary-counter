...
namespace SalaryCounter.Model.Dto
{
    ...
    public sealed class Employee
    {
        ...
        ///     Employment date
        /// </summary>
        [JsonProperty] public DateTime EmploymentDate { get; set; }
        /// <summary>
        ///     Base salary
        /// </summary>
        [JsonProperty] public decimal SalaryBase { get; set; }
        /// <summary>
        ///     Employee's position
        /// </summary>
        [JsonProperty] public EmployeeType EmployeeType { get; set; }
        /// <summary>
        ///     Employee chief's identifier
        /// </summary>
        [JsonProperty] public Guid? Chief { get; set; }
    }
}